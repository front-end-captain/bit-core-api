 ...
 * stack size exceeded".
 */
export function replaceBuffer(buffer: Buffer, oldStr: string, newStr: string): Buffer {
  if (!(buffer instanceof Buffer))
    throw new Error(`replaceBuffer expect to get Buffer, got ${typeof buffer} instead`);
