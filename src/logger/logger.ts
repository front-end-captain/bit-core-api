...
const { createExtensionLogger } = getWinstonLogger(logLevel, jsonFormat);
...
export const logger = new BitLogger(pinoLogger);
...
function getLogLevel(): Level {
  ...
  const level = (getSync(CFG_LOG_LEVEL) as string) || defaultLevel;
